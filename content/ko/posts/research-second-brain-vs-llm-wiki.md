...
**자료가 얇은 지점**: 질문에 언급된 CODE(Capture-Organize-Distill-Express) 약어 자체는 수집 자료에 등장하지 않으며, capture·distill 요소만 [1]에서 확인된다. Zettelkasten도 [4]에서 "human-curated PARA/Zettelkasten"으로 스치듯 언급될 뿐 상세 자료가 없다. 또한 수집 자료에는 Forte 원전들의 발표 시점이 명시되어 있지 않다.
